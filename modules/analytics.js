(function() {
    ...
    na = function(a, b) {
        if (!b || 1 > b.length) J(12);
            ...
            for (var c = [], d = 0; d < b.length; d++) {
                var e = b[d];
                var g = e.split(".");
                var ca = g.shift(); ("GA1" == ca || "1" == ca) && 1 < g.length ? (e = g.shift().split("-"), 1 == e.length && (e[1] = "1"), e[0] *= 1, e[1] *= 1, g = {
                    H: e,
                    s: g.join(".")
                }) : g = /^amp-/.test(e) ? {
                    H: [0, 0],
    ...
    Jc = function(a, b) {
        ...
        a: if (c = a.get(cc), d = E(M.location[c ? "href": "search"], "_ga")) if (a.get(bc)) if (c = d.indexOf("."), -1 == c) J(22);
        else {
    ...
    var ra = N.N,
    va = O[gb]; va && va.r ? ra() : z(ra); z(function() {
