...
height=600;
var count=0;
var currentcolor=document.getElementById('panel').style.backgroundColor;
var colors=[];
function updating(){
...
setInterval(function() {
    ...
    colors[a],
    1500 + 1e3 * Math.random(), parseInt(15 + 10 * Math.random()), 1 + 5 * Math.random()), fireworks[fireworks.length - 1].size = 4 + 3 * Math.random());
